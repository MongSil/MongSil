...
public class NetworkDefineConstant {
    ...
    public static final String SK_POI_SEARCH
            = "https://apis.skplanetx.com/tmap/pois?searchKeyword=%s&version=1";
    public static final String SK_WEATHER
            = "http://apis.skplanetx.com/weather/summary?lon=%s&lat=%s&version=1";
